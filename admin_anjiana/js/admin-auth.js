...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        if (user.email.toLowerCase().trim() === "admin@sageanjiana.com") {
            isAuthorized = true;
        } else {
            try {
...
if (loginForm) {
    loginForm.addEventListener('submit', async (e) => {
        ...
        // Wait 4.5 seconds for the loader animation as requested
        ...
        if (isStaffMode) {
            ...
            if (email === 'admin@sageanjiana.com') {
                if (errorMessage) {
            ...
            const modalHtml = `
                <div id="logoutConfirmModal" class="custom-modal-overlay">
                    <div class="custom-modal-card">
                        ...
                        <p>Are you sure you want to log out of the Sage Anjiana admin panel?</p>
