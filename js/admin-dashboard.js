    ...
    try {
        ...
        querySnapshot.forEach((docSnap) => {
            ...
            tr.innerHTML = `
                ...
                <td>${stockStatus}</td>
                <td>
                    <button class="btn btn-secondary edit-btn" data-id="${id}" style="padding: 6px 12px; font-size: 0.8rem;">Edit</button>
                    <button class="btn delete-btn" data-id="${id}" style="padding: 6px 12px; font-size: 0.8rem; background: #FFEBEE; color: #C62828;">Delete</button>
                </td>
            `;
